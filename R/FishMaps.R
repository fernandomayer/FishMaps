...
##' \describe{ \item{list("year")}{a factor with levels \code{2001}
##' \code{2002}} \item{list("lat")}{a numeric vector} \item{list("lon")}{a
##' numeric vector} \item{list("cpue")}{a numeric vector} }
...
##' \describe{ \item{list("year")}{a factor with levels \code{2001}
##' \code{2002}} \item{list("quarter")}{a factor with levels \code{1} \code{2}
##' \code{3} \code{4}} \item{list("lat")}{a numeric vector}
##' \item{list("lon")}{a numeric vector} \item{list("cpue")}{a numeric vector}
##' }
##' @source Randomly generated data.
##' @keywords datasets
##' @examples
...
##' \describe{ \item{list("year")}{a factor with levels \code{2001} \code{2002}
##' \code{2003} \code{2004} \code{2005}} \item{list("lat")}{a numeric vector}
##' \item{list("lon")}{a numeric vector} \item{list("cpue")}{a numeric vector}
##' }
##' @source Randomly generated data.
##' @keywords datasets
...
##' \describe{ \item{list("year")}{a factor with levels \code{2001} \code{2002}
##' \code{2003} \code{2004} \code{2005}} \item{list("quarter")}{a factor with
##' levels \code{1} \code{2} \code{3} \code{4}} \item{list("lat")}{a numeric
##' vector} \item{list("lon")}{a numeric vector} \item{list("cpue")}{a numeric
##' vector} }
##' @source Randomly generated data.
##' @keywords datasets
##' @examples
